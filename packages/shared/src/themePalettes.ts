...
export const T3_CHAT_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    sidebarRowHover: "oklch(0.978851 0.001321 106.424 / 0.08)",
    sidebarRowActive: "oklch(0.978851 0.001321 106.424 / 0.11)",
    sidebarRowSelected: "oklch(0.978851 0.001321 106.424 / 0.07)",
  ...
  variants: {
    dark: {
      ...
      sidebarRowHover: "oklch(0.23366 0.026081 338.196 / 0.08)",
      sidebarRowActive: "oklch(0.23366 0.026081 338.196 / 0.11)",
      sidebarRowSelected: "oklch(0.23366 0.026081 338.196 / 0.07)",
...
export const GROVE_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    sidebarRowHover: "oklch(0.886676 0.027374 164.983 / 0.08)",
    sidebarRowActive: "oklch(0.85335 0.03597 165.158 / 0.11)",
    sidebarRowSelected: "oklch(0.836654 0.040284 165.149 / 0.07)",
  ...
  variants: {
    dark: {
      ...
      sidebarRowHover: "oklch(0.374959 0.047124 159.686 / 0.08)",
      sidebarRowActive: "oklch(0.41688 0.056069 159.165 / 0.11)",
      sidebarRowSelected: "oklch(0.437466 0.060406 158.958 / 0.07)",
...
export const OCEAN_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    sidebarRowHover: "oklch(0.890798 0.024681 241.933 / 0.08)",
    sidebarRowActive: "oklch(0.858363 0.033325 242.089 / 0.11)",
    sidebarRowSelected: "oklch(0.842113 0.037689 242.174 / 0.07)",
  ...
  variants: {
    dark: {
      ...
      sidebarRowHover: "oklch(0.353381 0.042285 245.043 / 0.08)",
      sidebarRowActive: "oklch(0.393878 0.048778 244.179 / 0.11)",
      sidebarRowSelected: "oklch(0.413744 0.051943 243.848 / 0.07)",
...
export const EMBER_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    sidebarRowHover: "oklch(0.894819 0.024151 49.073 / 0.08)",
    sidebarRowActive: "oklch(0.863104 0.032855 48.586 / 0.11)",
    sidebarRowSelected: "oklch(0.84723 0.037292 48.403 / 0.07)",
  ...
  variants: {
    dark: {
      ...
      sidebarRowHover: "oklch(0.356163 0.042933 49.385 / 0.08)",
      sidebarRowActive: "oklch(0.396617 0.051353 50.201 / 0.11)",
      sidebarRowSelected: "oklch(0.416477 0.055442 50.489 / 0.07)",
...
export const IRIS_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    sidebarRowHover: "oklch(0.892522 0.030022 299.704 / 0.08)",
    sidebarRowActive: "oklch(0.85971 0.040501 299.36 / 0.11)",
    sidebarRowSelected: "oklch(0.843236 0.045818 299.198 / 0.07)",
  ...
  variants: {
    dark: {
      ...
      sidebarRowHover: "oklch(0.320808 0.062152 294.23 / 0.08)",
      sidebarRowActive: "oklch(0.355677 0.073167 294.217 / 0.11)",
      sidebarRowSelected: "oklch(0.372806 0.078525 294.203 / 0.07)",
