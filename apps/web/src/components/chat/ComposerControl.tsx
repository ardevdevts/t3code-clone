...
const composerControlClassName =
  "h-7 min-h-7 gap-1.5 rounded-[var(--control-radius)] px-2.5 text-[14px] font-medium text-secondary-label transition-none hover:text-foreground [&_svg[data-composer-control-icon]]:mx-0 [&_svg[data-composer-control-chevron]]:-mx-0.5";
